<?php $prompt="Prompt: Music Player" ?>

<link rel="stylesheet" href="ASSET/css/dailyUi/9.css">
...
<div id="all9">
    <div class="mobile">
        ...
        <div class="content">
            <img src="ASSET/img/dailyUi/9/cover.jpg" alt="Image Cover">
            <div class="songInfo">
                <p class="title">Intro</p>
                <p class="artist">Damso</p>
                <p class="album">QALF infinity</p>
            </div>
            <div class="allLyrics">
                <div class="iconTitle">
                ...
                <div class="lyrics">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae est ipsum hic aspernatur voluptates quod 
                        ex consequatur mollitia eos repellat corrupti aperiam cum maxime, et quasi soluta dolore quaerat. Esse 
                        commodi magnam iusto blanditiis ex deleniti assumenda a atque consequuntur.
                    </p>
                </div>
            </div>
            <div class="progressBar">
                <progress value="120" max="340">120</progress> 
                <div class="timer">
                    <p>1:20</p>
                    <p>3:40</p>
                </div>
            ...
            <div class="iconsBas">
                ...
                <svg class="play" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-play"><polygon points="6 3 20 12 6 21 6 3"/></svg>
                <div class="droite">
                    ...
                    <svg class="like" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                </div> 
            </div>
        </div>
    </div>
